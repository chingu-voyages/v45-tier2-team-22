...
const countStrikesByYearAndClass = (dataset: StrikeData[]): StrikeCounts[] => {
...
// const recclassObjects = strikeComposition.map((recclass) => {
  ...
  <div className="container">
    <div className="metric-container">
      <p className="metric-title">Summary Total: {amountOfStrikes} Strikes </p>
      <p className="metric-title"> Average Weight Of Meteor: {averageMass}kg</p>
    </div>
